...
const Testimonials=({blok}:{blok:any})=>{
    ...
    return(
            ...
            <div className=" flex gap-[20px] items-baseline">
                <button onClick={()=>handleValue('-')} className=" flex w-[30px] md:w-[65px] h-[30px] md:h-[65px] rounded-full border-[1px] text-brand border-brand items-center justify-center">

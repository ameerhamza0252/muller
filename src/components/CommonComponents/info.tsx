...
export default function Info({blok}:{blok:any}){
    //console.log(blok)
    return(
        <div className=" h-screen flex flex-col items-center  px-[20px] md:px-[40px] lg:px-[64px] xl:px-[94px] py-[36px] md:py-[66px] lg:py-[112px] xl:[150px] text-black" id={blok.anchor_id} {...storyblokEditable(blok)}>

...
export default function MarketPoints({blok}:{blok:any}){
    ...
    return(
        <div ref={ref} className=" grid grid-cols-2 lg:grid-cols-4 xl:grid-cols-4 px-[20px] py-[40px] lg:px-[64px] lg:py-[112px] gap-[48px] " style={{backgroundColor:colors[0].background_color,color:colors[0].text_color}} id={blok.anchor_id} {...storyblokEditable(blok)}>
                {

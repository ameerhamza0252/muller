...
export default function SolutionsList({blok}:{blok:any}){
  ...
  //console.log(blok,"Solution here")
    ...
    return(
        ...
        <div className={`flex flex-col h-auto py-[30px] lg:py-[95px] px-[10px] md:px-[24px] xl:px-[34px]`} style={{backgroundColor:colors[0].background_color,color:colors[0].text_color}} >

...
export async function CareerDescription({blok}:{blok:any}){
    ...
    return(
        <div className=" flex items-center justify-center lg:gap-[80px] px-[10px] py-[40px] lg:py-[112px]" style={{backgroundColor:colors[0].background_color,color:colors[0].text_color}} id={blok.anchor_id} {...storyblokEditable(blok)}>
